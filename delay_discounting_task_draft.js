...
let expName = 'delay_discounting_task_draft';  // from the Builder filename that created this script
let expInfo = {
...
psychoJS.start({
  ...
  resources: [
    // resources:
    {'name': 'discounting.xlsx', 'path': 'discounting.xlsx'},
  ]
});
...
async function experimentInit() {
  ...
  text_2 = new visual.TextStim({
    win: psychoJS.window,
    name: 'text_2',
    text: 'In this task you have to decide \nif you want a reward today or later\n\nPress "t" for today \nor "l" for later \n\nPress the spacebar to start the task',
    font: 'Open Sans',
    units: undefined, 
  ...
  text_3 = new visual.TextStim({
    win: psychoJS.window,
    name: 'text_3',
    text: 'Thank you, that was the task\n\nPress the spacebar and go back to the questionnaires',
    font: 'Open Sans',
    units: undefined, 
    pos: [0, 0], height: 0.05,  wrapWidth: undefined, ori: 0.0,
    languageStyle: 'LTR',
...
function trialRoutineBegin(snapshot) {
  return async function () {
    ...
    text.setText((((((((("EURO " + reward_today.toString()) + " today") + " OR") + " EURO") + reward_later.toString()) + " after ") + delay.toString()) + " days"));
...
function trialRoutineEachFrame() {
  return async function () {
    ...
    if (key_resp.status === PsychoJS.Status.STARTED) {
      let theseKeys = key_resp.getKeys({keyList: ['t', 'l'], waitRelease: false});
